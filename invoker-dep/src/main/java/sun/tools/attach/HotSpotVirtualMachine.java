...
/**
 * The HotSpot implementation of com.sun.tools.sun.tools.com.sun.tools.attach.VirtualMachine.
 */
public abstract class HotSpotVirtualMachine extends VirtualMachine
{
   ...
   // -- sun.tools.com.sun.tools.attach timeout support

   private static final long defaultAttachTimeout = 5000;
   private volatile long attachTimeout;

   /**
    * Return sun.tools.com.sun.tools.attach timeout based on the value of the sun.tools.sun.tools.com.sun.tools.attach.attachTimeout
   ...
   long attachTimeout()
   {
      if (attachTimeout == 0) {
         synchronized (this) {
            if (attachTimeout == 0) {
               try {
                  String s = System.getProperty("sun.tools.sun.tools.com.sun.tools.attach.attachTimeout");
