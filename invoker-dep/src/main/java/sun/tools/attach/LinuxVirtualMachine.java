...
public final class LinuxVirtualMachine extends HotSpotVirtualMachine
{
      ...
      throws AttachNotSupportedException, IOException
   {
      ...
      // sun.tools.com.sun.tools.attach mechanism in the target VM by sending it a QUIT signal.
      ...
      if (path == null) {
         ...
         try {
            ...
            // give the target VM time to start the sun.tools.com.sun.tools.attach mechanism
            int i = 0;
            long delay = 200;
   ...
   // On Solaris/Linux a simple handshake is used to start the sun.tools.com.sun.tools.attach mechanism
