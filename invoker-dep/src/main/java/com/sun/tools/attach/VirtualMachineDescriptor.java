 ...
 * com.sun.tools.attach.spi.AttachProvider com.sun.tools.attach providers}.
 *
 * @since 1.6
 */
public final class VirtualMachineDescriptor
{
    ...
    *
    * @param provider    The AttachProvider to com.sun.tools.attach to the Java virtual machine.
