 ...
 * written in the Java Language might com.sun.tools.attach to a running application and load its
 * profiler agent to profile the running application. </p>
 * <p/>
 * <p> A VirtualMachine is obtained by invoking the {@link #attach(String) com.sun.tools.attach} method
 ...
 * {@link #attach(VirtualMachineDescriptor) com.sun.tools.attach} method with a {@link
 ...
 * <pre>
 * <p/>
 *      // com.sun.tools.attach to target VM
 *      VirtualMachine vm = VirtualMachine.com.sun.tools.attach("2177");
 * <p/>
 ...
 * </pre>
 * <p/>
 * <p> In this example we com.sun.tools.attach to a Java virtual machine that is identified by
...
public abstract class VirtualMachine
{
    ...
    *
    * @param provider The com.sun.tools.attach provider creating this class.
    ...
    * <p/>
    * This method returns a list of Java {@link VirtualMachineDescriptor}
    ...
    * com.sun.tools.attach providers}.  If there are no Java virtual machines known to any provider then an empty
    * list is returned.
    *
    ...
    * <p/>
    * This method obtains the list of com.sun.tools.attach providers by invoking the
    ...
    * of the providers can com.sun.tools.attach to it. This exception is also thrown if
    ...
    * Attaches to a Java virtual machine.
    * <p/>
    * This method first invokes the {@link VirtualMachineDescriptor#provider()
    * provider()} method of the given virtual machine descriptor to obtain the com.sun.tools.attach provider.
    * It then invokes the com.sun.tools.attach provider's {@link
    * com.sun.tools.attach.spi.AttachProvider#attachVirtualMachine(VirtualMachineDescriptor)
    * attachVirtualMachine} to com.sun.tools.attach to the target VM.
    *
    ...
    *          If the com.sun.tools.attach provider's <code>attachVirtualmachine</code>
    ...
    *                                      another reason.
    * @throws com.sun.tools.attach.AgentInitializationException If the <code>Agent_OnAttach</code> function returns an error
    * @throws java.io.IOException                  If an I/O error occurs
    ...
    * @throws com.sun.tools.attach.AgentInitializationException If the <code>agentmain</code> throws an exception
    * @throws java.io.IOException                  If an I/O error occurs
