 ...
 * <p/>
 * <p> An com.sun.tools.attach provider is a concrete subclass of this class that has a
 * zero-argument constructor and implements the abstract methods specified
 * below. </p>
 * <p/>
 * <p> An com.sun.tools.attach provider implementation is typically tied to a Java virtual
 ...
 * JDK implementation ships with provider implementations that can only com.sun.tools.attach to
 ...
 * vendors then there will be an com.sun.tools.attach provider implementation for each
 * <i>family</i> of implementations or versions. </p>
 * <p/>
 * <p> An com.sun.tools.attach provider is identified by its {@link #name <i>name</i>} and
 ...
 * for example, ships with com.sun.tools.attach providers that use the name <i>"sun"</i>. The
 * <i>type</i> typically corresponds to the com.sun.tools.attach mechanism. For example, an
...
public abstract class AttachProvider
{
    ...
    * is thrown. Once parsed this method attempts to com.sun.tools.attach to the Java virtual machine.
    ...
    * the com.sun.tools.attach mechanism implemented by this provider, or it detects that the
    * Java virtual machine is a version to which this provider cannot com.sun.tools.attach, then
    ...
    * @throws com.sun.tools.attach.AttachNotSupportedException If the identifier cannot be parsed, or it corresponds to
    *                                     to a Java virtual machine that does not exist, or it
    *                                     corresponds to a Java virtual machine which this
    *                                     provider cannot com.sun.tools.attach.
    ...
    * to check that it is equal to this provider. It then attempts to com.sun.tools.attach to the
    ...
    *                                     <tt>("attachVirtualMachine")</tt>, or other permission
    *                                     required by the implementation.
    * @throws com.sun.tools.attach.AttachNotSupportedException If the descriptor's {@link
    *                                     com.sun.tools.attach.VirtualMachineDescriptor#provider() provider()} method
    *                                     returns a provider that is not this provider, or it does not correspond
    *                                     to a Java virtual machine to which this provider can com.sun.tools.attach.
    * @throws java.io.IOException                 If some other I/O error occurs
    ...
    * to which this provider can <i>potentially</i> com.sun.tools.attach.  There isn't any
   ...
   /**
    * Returns a list of the installed com.sun.tools.attach providers.
    * <p/>
    ...
    * <tt>com.sun.tools.com.sun.tools.attach.spi.AttachProvider</tt> in the resource directory
    ...
    *
    * @return A list of the installed com.sun.tools.attach providers.
    */
